...
import fr.varyon.ecotale.jobs.config.EcotaleJobsConfig.DepthBonusConfig;
import fr.varyon.ecotale.jobs.config.EcotaleJobsConfig.SecurityConfig;
import fr.varyon.ecotale.jobs.config.EcotaleJobsConfig.VeinStreakConfig;
...
import fr.varyon.ecotale.jobs.util.VeinStreakTracker;
